...
def update(obj,dis_obj,curr_path):
    ...
    if "india_current.json" in os.listdir(curr_path):
        with open(os.path.join(curr_path,"india_current.json"),"r") as f:
            curr_data = json.load(f)
        
        save_date = datetime.strptime(curr_data["UpdatedTill"],"%m/%d/%Y")
